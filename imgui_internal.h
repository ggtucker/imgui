...
namespace ImGui
{
    ...
    IMGUI_API void          RenderText(ImVec2 pos, const char* text, const char* text_end = NULL, bool hide_text_after_hash = true, ImGuiTextColorCallback color_callback = NULL, void* color_user_data = NULL);
    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width, ImGuiTextColorCallback color_callback = NULL, void* color_user_data = NULL);
    ...
    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0, ImGuiTextColorCallback color_callback = NULL, void* color_user_data = NULL);
    ...
    // InputText
    IMGUI_API bool          InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, ImGuiTextColorCallback color_callback = NULL, void* color_user_data = NULL);
